...
=back
    ...
    my $logged = IMGames::Log->admin_log( \%log_data );
...
=back
    ...
    my $logged = IMGames::Log->user_log( \%log_data );
...
=back
    ...
    my $logs = IMGames::Log->get_admin_logs( page => 1, per_page => 50 );
...
=back
    ...
    my $logs = IMGames::Log->get_user_logs( page => 1, per_page => 50 );

package IMGames::Schema::Result::ProductNotify;
...
IMGames::Schema::Result::ProductNotify
...
This module represents the Product Notification object in the web app, as well as the interface to the C<product_notify> table in the database.

=cut

__PACKAGE__->table( 'product_notify' );
__PACKAGE__->add_columns(
                          id =>
                            {
                              accessor          => 'product_notify',
                              data_type         => 'integer',
                              size              => 20,
                              is_nullable       => 0,
                              is_auto_increment => 1,

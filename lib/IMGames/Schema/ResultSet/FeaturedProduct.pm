package IMGames::Schema::ResultSet::FeaturedProduct;
...
IMGames::Schema::ResultSet::FeaturedProduct
...
This module handles ResultSet objects for the FeaturedProduct objects. Primarily, it's here for random ordering.
